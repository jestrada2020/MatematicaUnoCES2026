...
uno traslada las palabras a una forma equivalente del problema en la que usamos símbolos matemáticos, resolvemos esta forma equivalente y luego interpretamos la respuesta. (ó verificamos la respuesta)
...
6. Muchos problemas requieren de un período de incubación.
    Si te sientes frustrado, no dudes en tomarte un descanso 
    el subconsciente se hará cargo. 
...
9. Muchos problemas se pueden de resolver de distintas formas:
    solo se necesita encontrar una para tener éxito.
...
13. Siempre, siempre mira hacia atrás:
      Trata de establecer con precisión, cuál fue el paso clave en tu solución.

14. Ten cuidado en dejar tu solución escrita con suficiente claridad
      de tal modo puedas entenderla si la lees 10 años después.

15. Ayudar a que otros a que desarrollen habilidades en la solución de problemas
     es una gran ayuda para uno mismo: No les des soluciones;
     en su lugar provéelos con sugerencias significativas.
...
**<font color='black'>Escriba la definición de esta variable</font>**
...
## **Sugerencia para resolver un problema según George Polya (13 Dic1887-7Sep1985)**

<div class="figure" style="text-align: center">
<img src="images/GeorgePolya1887-1985.jpg" alt="George Polya (1887-1985) [Imagen tomada de [@stewart2015algebra] pág $P1$]"  />
<p class="caption">(\#fig:GeorgePolya1)George Polya (1887-1985) [Imagen tomada de [@stewart2015algebra] pág $P1$]</p>
</div>
...
* Concédete un tiempo razonable para resolver el problema. Si no tienes éxito solicita una sugerencia o haz el problema a un lado por un momento 
      <font color='red'>(¡puede que "se te prenda el foco" cuando menos lo esperes!)</font>.
...
<div class="figure" style="text-align: center">
<img src="images/TrianguloVertice.jpg" alt="Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $197$]"  />
<p class="caption">(\#fig:Dimensiones1)Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $197$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag123TextoGuia.jpg" alt="Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $123$]"  />
<p class="caption">(\#fig:Dimensiones2)Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $123$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag132TextoGuia.jpg" alt="Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $132$]"  />
<p class="caption">(\#fig:Dimensiones3)Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $132$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag133TextoGuia.jpg" alt="Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $133$]"  />
<p class="caption">(\#fig:Dimensiones4)Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $133$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag119y120TextoGuia.jpg" alt="Tabla Interés simple [Imagen tomada de [@zill2012algebra] pág $120$]"  />
<p class="caption">(\#fig:Regla3simple1)Tabla Interés simple [Imagen tomada de [@zill2012algebra] pág $120$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag120y121TextoGuia.jpg" alt="Tabla de velocidad [Imagen tomada de [@zill2012algebra] pág $121$]"  />
<p class="caption">(\#fig:velocidad1)Tabla de velocidad [Imagen tomada de [@zill2012algebra] pág $121$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag121MezclaTextoGuia.jpg" alt="Tabla de mezcla [Imagen tomada de [@zill2012algebra] pág $121$]"  />
<p class="caption">(\#fig:mezcla1a)Tabla de mezcla [Imagen tomada de [@zill2012algebra] pág $121$]</p>
</div>
...
<font color='red'>Si un individuo puede hacer todo el trabajo en $T$ unidades de tiempo, entonces en $x$ unidades de tiempo se termina una parte $\dfrac{x}{T}$ del trabajo</font>.
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaPag122TrabajoTextoGuia.jpg" alt="Tabla de trabajo [Imagen tomada de [@zill2012algebra] pág $122$]"  />
<p class="caption">(\#fig:trabajo2)Tabla de trabajo [Imagen tomada de [@zill2012algebra] pág $122$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/RelacionDirecta1.jpg" alt="Proporción directa [Imagen tomada de [@zill2012algebra] pág $190$]"  />
<p class="caption">(\#fig:proporcion1)Proporción directa [Imagen tomada de [@zill2012algebra] pág $190$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/RelacionInversa1.jpg" alt="Proporción inversa [Imagen tomada de [@zill2012algebra] pág $192$]"  />
<p class="caption">(\#fig:proporcion2)Proporción inversa [Imagen tomada de [@zill2012algebra] pág $192$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/ProblemaCajaC.jpg" alt="Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $137$]"  />
<p class="caption">(\#fig:caja2)Problema de dimensiones [Imagen tomada de [@zill2012algebra] pág $137$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/TrianguloArea.jpg" alt="Área de un rectángulo [Imagen tomada de [@zill2012algebra] pág $568$]"  />
<p class="caption">(\#fig:area1)Área de un rectángulo [Imagen tomada de [@zill2012algebra] pág $568$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/RectaTangente1.jpg" alt="Ecuación de la recta secante [Imagen tomada de [@zill2012algebra] pág $189$]"  />
<p class="caption">(\#fig:EcRecta1)Ecuación de la recta secante [Imagen tomada de [@zill2012algebra] pág $189$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/Circulo3.jpg" alt="Área sombreada [Imagen tomada de [@zill2012algebra] pág $264$]"  />
<p class="caption">(\#fig:Area2)Área sombreada [Imagen tomada de [@zill2012algebra] pág $264$]</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/RectaTangente3.jpg" alt="Ecuación de la recta tangente [Imagen tomada de [@zill2012algebra] pág $197$]"  />
<p class="caption">(\#fig:EcRecta2)Ecuación de la recta tangente [Imagen tomada de [@zill2012algebra] pág $197$]</p>
</div>
